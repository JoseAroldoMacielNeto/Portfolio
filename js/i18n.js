...
const traducoes = {
  ...
  pt: {
    ...
    proj_jarvis_desc: "Aplicativo para Windows que controla apresentações do PowerPoint por gestos das mãos, com reconhecimento processado 100% local e suíte de 247 testes automatizados. Desenvolvido com apoio de IA e publicado gratuitamente na Microsoft Store.",
  ...
  en: {
    ...
    proj_jarvis_desc: "Windows app that controls PowerPoint presentations through hand gestures, with recognition processed fully on-device and a suite of 247 automated tests. Built with AI support and published for free on the Microsoft Store.",
