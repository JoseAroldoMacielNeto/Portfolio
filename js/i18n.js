...
const traducoes = {
  ...
  pt: {
    ...
    proj_jarvis_title: "JARVIS — Controle por Gestos",
    proj_jarvis_desc: "Aplicativo para Windows que controla apresentações do PowerPoint por gestos das mãos captados pela webcam. Reconhecimento em tempo real com processamento 100% local — nenhuma imagem sai do computador —, trava de segurança que só envia comandos quando o PowerPoint está em foco e suíte de 247 testes automatizados. Desenvolvido com apoio de IA e publicado gratuitamente na Microsoft Store.",
    proj_jarvis_link_store: "Ver na Microsoft Store",
    proj_jarvis_codigo_privado: "Código privado",
    ...
    proj_placeholder_desc: "Espaço reservado para o próximo projeto da graduação.",
  ...
  en: {
    ...
    proj_jarvis_title: "JARVIS — Gesture Control",
    proj_jarvis_desc: "Windows app that controls PowerPoint presentations through hand gestures captured by the webcam. Real-time recognition with fully local processing — no image ever leaves the computer —, a safety lock that only sends commands while PowerPoint is in focus, and a suite of 247 automated tests. Built with AI support and published for free on the Microsoft Store.",
    proj_jarvis_link_store: "View on Microsoft Store",
    proj_jarvis_codigo_privado: "Private repository",
    ...
    proj_placeholder_desc: "Placeholder for my next project during the degree.",
